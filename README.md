...
3.  **Choose Filter Mode**:
    - **Exclude**: Rows in the "left CSV" that have values matching any value in the selected "right CSV" column will be _excluded_ from the results.
    - **Include**: Only rows in the "left CSV" that have values matching any value in the selected "right CSV" column will be _included_ in the results.
